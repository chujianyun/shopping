...
//				store.clearFilter(false);
		...
		{xtype:'combobox',width:175,
		    ...
		    store:Ext.create('Ext.data.Store', {
					  fields: ['id', 'name','extLocal','projectLocal'],
						 storeId: 'languageStore',
						 model:'cluing.model.LanguageModel',
						 
					     data : [
					             {id: 'CN',name:'简体中文',extLocal: 'ext-locale-zh_CN.js',projectLocal:'ext-locale-project-zh_CN.js'},
					             {id: 'en',name:'English',extLocal: 'ext-locale-en.js',projectLocal:'ext-locale-project-en.js'},
					             {id: 'TW',name:'繁體中文',extLocal: 'ext-locale-zh_TW.js',projectLocal:'ext-locale-project-zh_TW.js'}
					         ],
					         autoLoad:true
					 }),
		    queryMode: 'local',
