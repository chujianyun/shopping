...
<tr style="margin:50% auto;">
	<td>
	<center><h1>谢谢您在本站购物!欢迎<a href="./index.do"><font color="green">继续</font></a>。否则<a href="javascript:if(document.all){//IEwindow.open('', '_parent', '');window.close();}else{//FFwindow.open('', '_self', '');window.close();}"><font color="red">关闭</font></a></h1></center>
	</td>
</tr>
</table>
</center>
