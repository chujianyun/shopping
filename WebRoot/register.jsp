...
<div align="center" style="margin:-8px 0 -8px 0;">
  <table width="1024" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      hi，<c:if test="${username==null}"><c:set var="username" value="游客" /></c:if><font size="6" color="red">${username } </font>欢迎来我佳炒货网上商城！请<a href="#">登录</a> <a href="#">免费注册</a> <a href="#">我的订单</a> <a href="#" class="btn">
